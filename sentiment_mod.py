...
class VoteClassifier(ClassifierI):
    ...
    def confidence(self, features):
        ...
        return conf
print "Lets open the pickle files"
os.chdir (r'/home/sikinijj/Development/twitter/pickled_algos')
print "pickle folder opened"
documents_f = open("documents.pickle", "rb")
documents = pickle.load(documents_f)
documents_f.close()
print "documents opened and closed"

os.chdir (r'/home/sikinijj/Development/twitter/pickled_algos')
word_features5k_f = open("word_features5k.pickle","rb")
word_features = pickle.load(word_features5k_f)
word_features5k_f.close()
print "word_features5K_f opened and closed"
...
featuresets_f.close()
print "featuresets opened and closed"
